...
class Graph:
    ...
    def KruskalMST(self,s,t):
        ...
        treee =[] #This will store the resultant MST

        i = 0
        iter = 0
            #arr.append(g.graph[i][2])
        # print(arr)
...
'''Main Function which will drive the function'''
...
def main():
    ...
    print("The Parent Array[ ] starts for each iteration (random s and t):")
    ...
    for i in range(0,25):
        ...
        print("Time for finding s-t only, when using the Max Spanning Tree already generated : -- ", round(stop2-start2,6), "Seconds")
        time2 = stop2-start2

        print("Total time, if we include calculating the Max Spanning Tree : ", round(time1+time2,6), "seconds")
        print("---------------------------------------------")
