...
class Heap():
    ...
    def maxHeapify(self, elem):
        ...
        #print(self.array[smallest][0])
        #print(self.array[smallest][1])    ######## COMMENTED OUT!!!!
        ...
        if smallest != elem:
            ...
            # Swap positions
            self.pos[ self.array[smallest][0] ] = elem
            self.pos[ self.array[elem][0]] = smallest

            #print("array before swap is ", self.array)

            # Swap nodes
            self.swapMaxHeapNode(smallest, elem)
